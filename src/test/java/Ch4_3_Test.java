...
public class Ch4_3_Test {
    ...
    public void testPoint() {
        Ch4_3.Point p1 = app.new Point(1, 2);
        assertEquals(1, p1.getX());
        assertEquals(2, p1.getY());
        Ch4_3.Point p2 = app.new Point(1, 2);
    ...
    public void testLabeledPoint() {
        Ch4_3.LabeledPoint lp1 = app.new LabeledPoint(1, 2, "foo");
        assertEquals(1, lp1.getX());
        assertEquals(2, lp1.getY());
        assertEquals("foo", lp1.getLabel());
        Ch4_3.LabeledPoint lp2 = app.new LabeledPoint(1, 2, "foo");
